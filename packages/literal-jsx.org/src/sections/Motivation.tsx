  ...
  return (
    <section id="motivation">
      ...
      <p>
        ...
        obtained. One the one hand, JSX is easily parseable (due to its
      ...
      <p>
        JSX aims to privide a <em>straightforward and intuitive standard</em>{" "}
        for content-authoring in the component-based design era.
      </p>
    </section>
  );
}
